...
#define __PYX_HAVE__grad_b
#define __PYX_HAVE_API__grad_b
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'grad_b' */
...
static __Pyx_memviewslice __pyx_f_6grad_b_gb(__Pyx_memviewslice, __Pyx_memviewslice, float, float, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "grad_b"
extern int __pyx_module_is_main_grad_b;
int __pyx_module_is_main_grad_b = 0;

/* Implementation of 'grad_b' */
...
static PyObject *__pyx_pf_6grad_b_gb(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img1, __Pyx_memviewslice __pyx_v_img2, float __pyx_v_alpha, float __pyx_v_height, int __pyx_v_order); /* proto */
 ...
 * cimport cython
 * 
 * cpdef unsigned char[:, :, :] gb(unsigned char [:, :, :] img1, unsigned char [:, :, :] img2, float alpha, float height, int order):             # <<<<<<<<<<<<<<
 *     cdef int x, y, w, h
 *     cdef float row_alpha
 */

static PyObject *__pyx_pw_6grad_b_1gb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_6grad_b_gb(__Pyx_memviewslice __pyx_v_img1, __Pyx_memviewslice __pyx_v_img2, float __pyx_v_alpha, float __pyx_v_height, int __pyx_v_order, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_w;
  int __pyx_v_h;
  float __pyx_v_row_alpha;
 ...
 *     if order == 1:
 */
  __pyx_v_h = (__pyx_v_img1.shape[0]);
 ...
 *     w = img1.shape[1]             # <<<<<<<<<<<<<<
 *     if order == 1:
 *         for y in range(int(height*h), h):
 */
  __pyx_v_w = (__pyx_v_img1.shape[1]);
 ...
 *     if order == 1:             # <<<<<<<<<<<<<<
 *         for y in range(int(height*h), h):
 *             row_alpha = (1/height) * (alpha - 1) * (y - height*h) / h + 1
 */
 ...
 */
    __pyx_t_2 = __pyx_v_h;
    __pyx_t_3 = __pyx_t_2;
    for (__pyx_t_4 = ((long)(__pyx_v_height * __pyx_v_h)); __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      __pyx_v_y = __pyx_t_4;
 ...
 */
      ...
      __pyx_t_5 = (((1.0 / __pyx_v_height) * (__pyx_v_alpha - 1.0)) * (__pyx_v_y - (__pyx_v_height * __pyx_v_h)));
      if (unlikely(__pyx_v_h == 0)) {
        PyErr_SetString(PyExc_ZeroDivisionError, "float division");
        __PYX_ERR(0, 15, __pyx_L1_error)
      }
      __pyx_v_row_alpha = ((__pyx_t_5 / __pyx_v_h) + 1.0);
 ...
 *             for x in range(0, w):
 */
      __pyx_t_1 = ((__pyx_v_row_alpha < __pyx_v_alpha) != 0);
      if (__pyx_t_1) {
 ...
 *                 row_alpha = alpha             # <<<<<<<<<<<<<<
 *             for x in range(0, w):
 *                 img1[y, x, 0] = int(row_alpha*img1[y, x, 0] + (1 - row_alpha) * img2[y, x, 0])
 */
        __pyx_v_row_alpha = __pyx_v_alpha;
 ...
 *             for x in range(0, w):             # <<<<<<<<<<<<<<
 *                 img1[y, x, 0] = int(row_alpha*img1[y, x, 0] + (1 - row_alpha) * img2[y, x, 0])
 *                 img1[y, x, 1] = int(row_alpha*img1[y, x, 1] + (1 - row_alpha) * img2[y, x, 1])
 */
      __pyx_t_6 = __pyx_v_w;
      __pyx_t_7 = __pyx_t_6;
 ...
 *                 img1[y, x, 0] = int(row_alpha*img1[y, x, 0] + (1 - row_alpha) * img2[y, x, 0])             # <<<<<<<<<<<<<<
 *                 img1[y, x, 1] = int(row_alpha*img1[y, x, 1] + (1 - row_alpha) * img2[y, x, 1])
 *                 img1[y, x, 2] = int(row_alpha*img1[y, x, 2] + (1 - row_alpha) * img2[y, x, 2])
 */
        __pyx_t_9 = __pyx_v_y;
        ...
        __pyx_t_17 = 0;
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_15 * __pyx_v_img1.strides[0]) ) + __pyx_t_16 * __pyx_v_img1.strides[1]) ) + __pyx_t_17 * __pyx_v_img1.strides[2]) )) = ((unsigned char)((__pyx_v_row_alpha * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_9 * __pyx_v_img1.strides[0]) ) + __pyx_t_10 * __pyx_v_img1.strides[1]) ) + __pyx_t_11 * __pyx_v_img1.strides[2]) )))) + ((1.0 - __pyx_v_row_alpha) * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_12 * __pyx_v_img2.strides[0]) ) + __pyx_t_13 * __pyx_v_img2.strides[1]) ) + __pyx_t_14 * __pyx_v_img2.strides[2]) ))))));
 ...
 */
        ...
        __pyx_t_26 = 1;
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_24 * __pyx_v_img1.strides[0]) ) + __pyx_t_25 * __pyx_v_img1.strides[1]) ) + __pyx_t_26 * __pyx_v_img1.strides[2]) )) = ((unsigned char)((__pyx_v_row_alpha * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_18 * __pyx_v_img1.strides[0]) ) + __pyx_t_19 * __pyx_v_img1.strides[1]) ) + __pyx_t_20 * __pyx_v_img1.strides[2]) )))) + ((1.0 - __pyx_v_row_alpha) * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_21 * __pyx_v_img2.strides[0]) ) + __pyx_t_22 * __pyx_v_img2.strides[1]) ) + __pyx_t_23 * __pyx_v_img2.strides[2]) ))))));
 ...
 */
        ...
        __pyx_t_35 = 2;
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_33 * __pyx_v_img1.strides[0]) ) + __pyx_t_34 * __pyx_v_img1.strides[1]) ) + __pyx_t_35 * __pyx_v_img1.strides[2]) )) = ((unsigned char)((__pyx_v_row_alpha * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_27 * __pyx_v_img1.strides[0]) ) + __pyx_t_28 * __pyx_v_img1.strides[1]) ) + __pyx_t_29 * __pyx_v_img1.strides[2]) )))) + ((1.0 - __pyx_v_row_alpha) * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_30 * __pyx_v_img2.strides[0]) ) + __pyx_t_31 * __pyx_v_img2.strides[1]) ) + __pyx_t_32 * __pyx_v_img2.strides[2]) ))))));
      }
    }
 ...
 *                 row_alpha = alpha             # <<<<<<<<<<<<<<
 *             for x in range(0, w):
 *                 img2[y, x, 0] = int(row_alpha*img2[y, x, 0] + (1 - row_alpha) * img1[y, x, 0])
 */
        __pyx_v_row_alpha = __pyx_v_alpha;
 ...
 *             for x in range(0, w):             # <<<<<<<<<<<<<<
 *                 img2[y, x, 0] = int(row_alpha*img2[y, x, 0] + (1 - row_alpha) * img1[y, x, 0])
 *                 img2[y, x, 1] = int(row_alpha*img2[y, x, 1] + (1 - row_alpha) * img1[y, x, 1])
 */
      __pyx_t_6 = __pyx_v_w;
      __pyx_t_7 = __pyx_t_6;
      for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
 ...
 *                 img2[y, x, 0] = int(row_alpha*img2[y, x, 0] + (1 - row_alpha) * img1[y, x, 0])             # <<<<<<<<<<<<<<
 *                 img2[y, x, 1] = int(row_alpha*img2[y, x, 1] + (1 - row_alpha) * img1[y, x, 1])
 *                 img2[y, x, 2] = int(row_alpha*img2[y, x, 2] + (1 - row_alpha) * img1[y, x, 2])
 */
        ...
        __pyx_t_44 = 0;
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_42 * __pyx_v_img2.strides[0]) ) + __pyx_t_43 * __pyx_v_img2.strides[1]) ) + __pyx_t_44 * __pyx_v_img2.strides[2]) )) = ((unsigned char)((__pyx_v_row_alpha * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_36 * __pyx_v_img2.strides[0]) ) + __pyx_t_37 * __pyx_v_img2.strides[1]) ) + __pyx_t_38 * __pyx_v_img2.strides[2]) )))) + ((1.0 - __pyx_v_row_alpha) * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_39 * __pyx_v_img1.strides[0]) ) + __pyx_t_40 * __pyx_v_img1.strides[1]) ) + __pyx_t_41 * __pyx_v_img1.strides[2]) ))))));
 ...
 */
        ...
        __pyx_t_53 = 1;
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_51 * __pyx_v_img2.strides[0]) ) + __pyx_t_52 * __pyx_v_img2.strides[1]) ) + __pyx_t_53 * __pyx_v_img2.strides[2]) )) = ((unsigned char)((__pyx_v_row_alpha * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_45 * __pyx_v_img2.strides[0]) ) + __pyx_t_46 * __pyx_v_img2.strides[1]) ) + __pyx_t_47 * __pyx_v_img2.strides[2]) )))) + ((1.0 - __pyx_v_row_alpha) * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_48 * __pyx_v_img1.strides[0]) ) + __pyx_t_49 * __pyx_v_img1.strides[1]) ) + __pyx_t_50 * __pyx_v_img1.strides[2]) ))))));
 ...
 */
        ...
        __pyx_t_62 = 2;
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_60 * __pyx_v_img2.strides[0]) ) + __pyx_t_61 * __pyx_v_img2.strides[1]) ) + __pyx_t_62 * __pyx_v_img2.strides[2]) )) = ((unsigned char)((__pyx_v_row_alpha * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img2.data + __pyx_t_54 * __pyx_v_img2.strides[0]) ) + __pyx_t_55 * __pyx_v_img2.strides[1]) ) + __pyx_t_56 * __pyx_v_img2.strides[2]) )))) + ((1.0 - __pyx_v_row_alpha) * (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img1.data + __pyx_t_57 * __pyx_v_img1.strides[0]) ) + __pyx_t_58 * __pyx_v_img1.strides[1]) ) + __pyx_t_59 * __pyx_v_img1.strides[2]) ))))));
      }
    }
  }
  __pyx_L3:;
 ...
 *     return img1             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_img1, 0);
  __pyx_r = __pyx_v_img1;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("grad_b.gb", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
/* Python wrapper */
static PyObject *__pyx_pw_6grad_b_1gb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6grad_b_1gb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_img1,&__pyx_n_s_img2,&__pyx_n_s_alpha,&__pyx_n_s_height,&__pyx_n_s_order,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("gb", 1, 5, 5, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gb", 1, 5, 5, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_height)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gb", 1, 5, 5, 3); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_order)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gb", 1, 5, 5, 4); __PYX_ERR(0, 8, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "gb") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
    ...
    __pyx_v_img1 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img1.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_img2 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img2.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_alpha = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_alpha == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_height = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_height == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_order = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_order == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("gb", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("grad_b.gb", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6grad_b_gb(__pyx_self, __pyx_v_img1, __pyx_v_img2, __pyx_v_alpha, __pyx_v_height, __pyx_v_order);
...
static PyObject *__pyx_pf_6grad_b_gb(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img1, __Pyx_memviewslice __pyx_v_img2, float __pyx_v_alpha, float __pyx_v_height, int __pyx_v_order) {
  ...
  if (unlikely(!__pyx_v_img1.memview)) { __Pyx_RaiseUnboundLocalError("img1"); __PYX_ERR(0, 8, __pyx_L1_error) }
  if (unlikely(!__pyx_v_img2.memview)) { __Pyx_RaiseUnboundLocalError("img2"); __PYX_ERR(0, 8, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_6grad_b_gb(__pyx_v_img1, __pyx_v_img2, __pyx_v_alpha, __pyx_v_height, __pyx_v_order, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 8, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 3, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "grad_b._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"gb", (PyCFunction)__pyx_pw_6grad_b_1gb, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_grad_b(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_grad_b},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initgrad_b(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initgrad_b(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_grad_b(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_grad_b(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_grad_b(PyObject *__pyx_pyinit_module) CYTHON_SMALL_CODE 
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_grad_b(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("grad_b", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_grad_b) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "grad_b")) {
      if (unlikely(PyDict_SetItemString(modules, "grad_b", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init grad_b", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init grad_b");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
