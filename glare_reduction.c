...
#define __PYX_HAVE__glare_reduction
#define __PYX_HAVE_API__glare_reduction
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'glare_reduction' */
...
static PyObject *__pyx_f_15glare_reduction_glare(__Pyx_memviewslice, unsigned int, unsigned int, unsigned int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "glare_reduction"
extern int __pyx_module_is_main_glare_reduction;
int __pyx_module_is_main_glare_reduction = 0;

/* Implementation of 'glare_reduction' */
...
static PyObject *__pyx_pf_15glare_reduction_glare(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_hsv_image, unsigned int __pyx_v_threshold, unsigned int __pyx_v_c, unsigned int __pyx_v_factor); /* proto */
...
/* "glare_reduction.pyx":8
 * cimport cython
 * 
 * cpdef glare(unsigned char [:, :, :] hsv_image, unsigned int threshold, unsigned int c, unsigned int factor):             # <<<<<<<<<<<<<<
 *     cdef int height, width, i, j, new_height
 * 
 */

static PyObject *__pyx_pw_15glare_reduction_1glare(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_15glare_reduction_glare(__Pyx_memviewslice __pyx_v_hsv_image, unsigned int __pyx_v_threshold, unsigned int __pyx_v_c, unsigned int __pyx_v_factor, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_height;
  int __pyx_v_width;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  __Pyx_RefNannySetupContext("glare", 0);

  /* "glare_reduction.pyx":11
 *     cdef int height, width, i, j, new_height
 * 
 ...
 */
  __pyx_v_height = (__pyx_v_hsv_image.shape[0]);

  /* "glare_reduction.pyx":12
 * 
 *     height = hsv_image.shape[0]
 *     width = hsv_image.shape[1]             # <<<<<<<<<<<<<<
 *     new_height = int(height/factor)
 * 
 */
  __pyx_v_width = (__pyx_v_hsv_image.shape[1]);

  /* "glare_reduction.pyx":13
 *     height = hsv_image.shape[0]
 *     width = hsv_image.shape[1]
 *     new_height = int(height/factor)             # <<<<<<<<<<<<<<
 * 
 *     for i in range(0, (new_height - 1), 2):
 */
  if (unlikely(__pyx_v_factor == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "integer division or modulo by zero");
    __PYX_ERR(0, 13, __pyx_L1_error)
  }
  __pyx_v_new_height = ((int)(__pyx_v_height / __pyx_v_factor));

  /* "glare_reduction.pyx":15
 *     new_height = int(height/factor)
 * 
 *     for i in range(0, (new_height - 1), 2):             # <<<<<<<<<<<<<<
 *         for j in range(0, (width - 1), 2):
 *             if (hsv_image[i][j][2] > threshold):
 */
  __pyx_t_1 = (__pyx_v_new_height - 1);
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=2) {
    __pyx_v_i = __pyx_t_3;

    /* "glare_reduction.pyx":16
 * 
 *     for i in range(0, (new_height - 1), 2):
 *         for j in range(0, (width - 1), 2):             # <<<<<<<<<<<<<<
 *             if (hsv_image[i][j][2] > threshold):
 *                 hsv_image[i][j][2] = c * np.log10(1 + hsv_image[i][j][2])
 */
    __pyx_t_4 = (__pyx_v_width - 1);
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=2) {
      __pyx_v_j = __pyx_t_6;

      /* "glare_reduction.pyx":17
 *     for i in range(0, (new_height - 1), 2):
 *         for j in range(0, (width - 1), 2):
 *             if (hsv_image[i][j][2] > threshold):             # <<<<<<<<<<<<<<
 *                 hsv_image[i][j][2] = c * np.log10(1 + hsv_image[i][j][2])
 *                 hsv_image[i][j+1][2] = hsv_image[i][j][2]
 */
      __pyx_t_7 = __pyx_v_i;
      __pyx_t_8 = __pyx_v_j;
      __pyx_t_9 = 2;
      __pyx_t_10 = (((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_hsv_image.data + __pyx_t_7 * __pyx_v_hsv_image.strides[0]) ) + __pyx_t_8 * __pyx_v_hsv_image.strides[1]) ) + __pyx_t_9 * __pyx_v_hsv_image.strides[2]) ))) > __pyx_v_threshold) != 0);
      if (__pyx_t_10) {

        /* "glare_reduction.pyx":18
 *         for j in range(0, (width - 1), 2):
 *             if (hsv_image[i][j][2] > threshold):
 *                 hsv_image[i][j][2] = c * np.log10(1 + hsv_image[i][j][2])             # <<<<<<<<<<<<<<
 *                 hsv_image[i][j+1][2] = hsv_image[i][j][2]
 *                 hsv_image[i+1][j+1][2] = hsv_image[i][j][2]
 */
        __pyx_t_11 = __Pyx_PyInt_From_unsigned_int(__pyx_v_c); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 18, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_13 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 18, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __pyx_t_14 = __Pyx_PyObject_GetAttrStr(__pyx_t_13, __pyx_n_s_log10); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 18, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        __pyx_t_15 = __pyx_v_i;
        __pyx_t_16 = __pyx_v_j;
        __pyx_t_17 = 2;
        __pyx_t_13 = __Pyx_PyInt_From_long((1 + (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_hsv_image.data + __pyx_t_15 * __pyx_v_hsv_image.strides[0]) ) + __pyx_t_16 * __pyx_v_hsv_image.strides[1]) ) + __pyx_t_17 * __pyx_v_hsv_image.strides[2]) ))))); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 18, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_13);
        __pyx_t_18 = NULL;
        ...
        if (!__pyx_t_18) {
          __pyx_t_12 = __Pyx_PyObject_CallOneArg(__pyx_t_14, __pyx_t_13); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 18, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
          ...
          if (PyFunction_Check(__pyx_t_14)) {
            ...
            __pyx_t_12 = __Pyx_PyFunction_FastCall(__pyx_t_14, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 18, __pyx_L1_error)
          ...
          if (__Pyx_PyFastCFunction_Check(__pyx_t_14)) {
            PyObject *__pyx_temp[2] = {__pyx_t_18, __pyx_t_13};
            __pyx_t_12 = __Pyx_PyCFunction_FastCall(__pyx_t_14, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 18, __pyx_L1_error)
            __Pyx_XDECREF(__pyx_t_18); __pyx_t_18 = 0;
            __Pyx_GOTREF(__pyx_t_12);
            __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
          } else
          #endif
          {
            ...
            __pyx_t_13 = 0;
            __pyx_t_12 = __Pyx_PyObject_Call(__pyx_t_14, __pyx_t_19, NULL); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 18, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_12);
            __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
          }
        }
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
        __pyx_t_14 = PyNumber_Multiply(__pyx_t_11, __pyx_t_12); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 18, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
        __pyx_t_20 = __Pyx_PyInt_As_unsigned_char(__pyx_t_14); if (unlikely((__pyx_t_20 == (unsigned char)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
        __pyx_t_21 = __pyx_v_i;
        __pyx_t_22 = __pyx_v_j;
        __pyx_t_23 = 2;
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_hsv_image.data + __pyx_t_21 * __pyx_v_hsv_image.strides[0]) ) + __pyx_t_22 * __pyx_v_hsv_image.strides[1]) ) + __pyx_t_23 * __pyx_v_hsv_image.strides[2]) )) = __pyx_t_20;

        /* "glare_reduction.pyx":19
 *             if (hsv_image[i][j][2] > threshold):
 *                 hsv_image[i][j][2] = c * np.log10(1 + hsv_image[i][j][2])
 *                 hsv_image[i][j+1][2] = hsv_image[i][j][2]             # <<<<<<<<<<<<<<
 *                 hsv_image[i+1][j+1][2] = hsv_image[i][j][2]
 *                 hsv_image[i+1][j][2] = hsv_image[i][j][2]
 */
        ...
        __pyx_t_29 = 2;
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_hsv_image.data + __pyx_t_27 * __pyx_v_hsv_image.strides[0]) ) + __pyx_t_28 * __pyx_v_hsv_image.strides[1]) ) + __pyx_t_29 * __pyx_v_hsv_image.strides[2]) )) = (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_hsv_image.data + __pyx_t_24 * __pyx_v_hsv_image.strides[0]) ) + __pyx_t_25 * __pyx_v_hsv_image.strides[1]) ) + __pyx_t_26 * __pyx_v_hsv_image.strides[2]) )));

        /* "glare_reduction.pyx":20
 *                 hsv_image[i][j][2] = c * np.log10(1 + hsv_image[i][j][2])
 *                 hsv_image[i][j+1][2] = hsv_image[i][j][2]
 *                 hsv_image[i+1][j+1][2] = hsv_image[i][j][2]             # <<<<<<<<<<<<<<
 *                 hsv_image[i+1][j][2] = hsv_image[i][j][2]
 */
        ...
        __pyx_t_35 = 2;
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_hsv_image.data + __pyx_t_33 * __pyx_v_hsv_image.strides[0]) ) + __pyx_t_34 * __pyx_v_hsv_image.strides[1]) ) + __pyx_t_35 * __pyx_v_hsv_image.strides[2]) )) = (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_hsv_image.data + __pyx_t_30 * __pyx_v_hsv_image.strides[0]) ) + __pyx_t_31 * __pyx_v_hsv_image.strides[1]) ) + __pyx_t_32 * __pyx_v_hsv_image.strides[2]) )));

        /* "glare_reduction.pyx":21
 *                 hsv_image[i][j+1][2] = hsv_image[i][j][2]
 *                 hsv_image[i+1][j+1][2] = hsv_image[i][j][2]
 *                 hsv_image[i+1][j][2] = hsv_image[i][j][2]             # <<<<<<<<<<<<<<
 */
        ...
        __pyx_t_41 = 2;
        *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_hsv_image.data + __pyx_t_39 * __pyx_v_hsv_image.strides[0]) ) + __pyx_t_40 * __pyx_v_hsv_image.strides[1]) ) + __pyx_t_41 * __pyx_v_hsv_image.strides[2]) )) = (*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_hsv_image.data + __pyx_t_36 * __pyx_v_hsv_image.strides[0]) ) + __pyx_t_37 * __pyx_v_hsv_image.strides[1]) ) + __pyx_t_38 * __pyx_v_hsv_image.strides[2]) )));
 ...
 */
  ...
  __Pyx_AddTraceback("glare_reduction.glare", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_15glare_reduction_1glare(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_15glare_reduction_1glare(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_hsv_image = { 0, 0, { 0 }, { 0 }, { 0 } };
  unsigned int __pyx_v_threshold;
  unsigned int __pyx_v_c;
  unsigned int __pyx_v_factor;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("glare (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_hsv_image,&__pyx_n_s_threshold,&__pyx_n_s_c,&__pyx_n_s_factor,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_hsv_image)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_threshold)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("glare", 1, 4, 4, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("glare", 1, 4, 4, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_factor)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("glare", 1, 4, 4, 3); __PYX_ERR(0, 8, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "glare") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
    ...
    __pyx_v_hsv_image = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_hsv_image.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_threshold = __Pyx_PyInt_As_unsigned_int(values[1]); if (unlikely((__pyx_v_threshold == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyInt_As_unsigned_int(values[2]); if (unlikely((__pyx_v_c == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_factor = __Pyx_PyInt_As_unsigned_int(values[3]); if (unlikely((__pyx_v_factor == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("glare", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("glare_reduction.glare", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15glare_reduction_glare(__pyx_self, __pyx_v_hsv_image, __pyx_v_threshold, __pyx_v_c, __pyx_v_factor);
...
static PyObject *__pyx_pf_15glare_reduction_glare(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_hsv_image, unsigned int __pyx_v_threshold, unsigned int __pyx_v_c, unsigned int __pyx_v_factor) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("glare", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_hsv_image.memview)) { __Pyx_RaiseUnboundLocalError("hsv_image"); __PYX_ERR(0, 8, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_15glare_reduction_glare(__pyx_v_hsv_image, __pyx_v_threshold, __pyx_v_c, __pyx_v_factor, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_hsv_image, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "glare_reduction.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "glare_reduction._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"glare", (PyCFunction)__pyx_pw_15glare_reduction_1glare, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_glare_reduction(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_glare_reduction},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initglare_reduction(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initglare_reduction(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_glare_reduction(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_glare_reduction(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_glare_reduction(PyObject *__pyx_pyinit_module) CYTHON_SMALL_CODE 
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_glare_reduction(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("glare_reduction", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_glare_reduction) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "glare_reduction")) {
      if (unlikely(PyDict_SetItemString(modules, "glare_reduction", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init glare_reduction", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init glare_reduction");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
